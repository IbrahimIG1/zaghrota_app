...
class ArosaDevicesHomeOccScreen extends StatelessWidget {
  const ArosaDevicesHomeOccScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      floatingActionButton: BlocConsumer<HomeOccClothesCubit, HomeOccClothesState>(
                listener: (context, state) {
      
                },
                builder: (context, state) {
      var cubit = HomeOccClothesCubit.get(context);
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<HomeOccClothesCubit, HomeOccClothesState>(
          listener: (context, state) {
            
          },
          builder: (context, state) {
            if(state is HomeOccClothesSuccess){
            var cubit = HomeOccClothesCubit.get(context);
          ...
          else if (state is HomeOccClothesFailure){
  ...
  Future<void> updateDialog(BuildContext context, String? newval, HomeOccClothesSuccess state, int index, HomeOccClothesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, HomeOccClothesCubit cubit, int index) {
