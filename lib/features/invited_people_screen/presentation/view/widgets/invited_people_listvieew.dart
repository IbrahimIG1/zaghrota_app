...
class InvitedPeopleListvieew extends StatelessWidget {
  const InvitedPeopleListvieew({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<InvitedPeopleCubit, InvitedPeopleState>(
      listener: (context, state) {
        
      },
      builder: (context, state) {
        var cubit = InvitedPeopleCubit.get(context);
        if(state is GetInvitedPeopleFailure){
  ...
  void deleteDialog(BuildContext context, InvitedPeopleCubit cubit, int index) {
