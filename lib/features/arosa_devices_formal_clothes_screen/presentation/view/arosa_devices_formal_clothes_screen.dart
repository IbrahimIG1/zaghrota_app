...
class ArosaDevicesFormalClothesScreen extends StatelessWidget {
  const ArosaDevicesFormalClothesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      floatingActionButton: BlocConsumer<FormalClothesCubit, FormalClothesState>(
                listener: (context, state) {
      
                },
                builder: (context, state) {
      var cubit = FormalClothesCubit.get(context);
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<FormalClothesCubit, FormalClothesState>(
          listener: (context, state) {
            
          },
          builder: (context, state) {
            if(state is FormalClothesSuccess){
            var cubit = FormalClothesCubit.get(context);
          ...
          else if (state is FormalClothesFailure){
  ...
  Future<void> updateDialog(BuildContext context, String? newval, FormalClothesSuccess state, int index, FormalClothesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, FormalClothesCubit cubit, int index) {
