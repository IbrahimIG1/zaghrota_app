...
class ArosaDevicesAccessoriesScreen extends StatelessWidget {
  const ArosaDevicesAccessoriesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      floatingActionButton: BlocConsumer<AccessoriesCubit, AccessoriesState>(
  ...
  Future<void> updateDialog(BuildContext context, String? newval, AccessoriesSuccess state, int index, AccessoriesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, AccessoriesCubit cubit, int index) {
