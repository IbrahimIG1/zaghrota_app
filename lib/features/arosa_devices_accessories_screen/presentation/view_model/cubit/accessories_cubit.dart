...
import 'package:zaghrota_app/features/arosa_devices_accessories_screen/data/arosa_devices_accessories_screen_repo.dart';
...
class AccessoriesCubit extends Cubit<AccessoriesState> {
  AccessoriesCubit() : super(AccessoriesInitial());
   ArosaDevicesAccessoriesScreenRepo repo = ArosaDevicesAccessoriesScreenRepo();
GlobalKey<FormState> formKey = GlobalKey();
 static AccessoriesCubit get(context)=> BlocProvider.of<AccessoriesCubit>(context);
