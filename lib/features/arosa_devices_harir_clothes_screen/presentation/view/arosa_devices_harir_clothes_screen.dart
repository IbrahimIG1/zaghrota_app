...
class ArosaDevicesHarirClothesScreen extends StatelessWidget {
  const ArosaDevicesHarirClothesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      floatingActionButton: BlocConsumer<HarirClothesCubit, HarirClothesState>(
                listener: (context, state) {
      
                },
                builder: (context, state) {
      var cubit = HarirClothesCubit.get(context);
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<HarirClothesCubit, HarirClothesState>(
          listener: (context, state) {
            
          },
          builder: (context, state) {
            if(state is HarirClothesSuccess){
            var cubit = HarirClothesCubit.get(context);
          ...
          else if (state is HarirClothesFailure){
  ...
  Future<void> updateDialog(BuildContext context, String? newval, HarirClothesSuccess state, int index, HarirClothesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, HarirClothesCubit cubit, int index) {
