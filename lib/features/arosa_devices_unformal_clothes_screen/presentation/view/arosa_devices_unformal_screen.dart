...
class ArosaDevicesUnformalScreen extends StatelessWidget {
  const ArosaDevicesUnformalScreen({super.key});
  ...
  Widget build(BuildContext context) {
     return SafeArea(
      ...
      floatingActionButton: BlocConsumer<UnformalClothesCubit, UnformalClothesState>(
                listener: (context, state) {
      
                },
                builder: (context, state) {
      var cubit = UnformalClothesCubit.get(context);
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<UnformalClothesCubit, UnformalClothesState>(
          listener: (context, state) {
            
          },
          builder: (context, state) {
            if(state is UnformalClothesSuccess){
            var cubit = UnformalClothesCubit.get(context);
          ...
          else if (state is UnformalClothesFailure){
  ...
  Future<void> updateDialog(BuildContext context, String? newval, UnformalClothesSuccess state, int index, UnformalClothesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, UnformalClothesCubit cubit, int index) {
