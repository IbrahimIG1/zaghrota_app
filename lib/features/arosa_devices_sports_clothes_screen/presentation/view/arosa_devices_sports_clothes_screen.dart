...
class ArosaDevicesSportsClothesScreen extends StatelessWidget {
  const ArosaDevicesSportsClothesScreen({super.key});
  ...
  Widget build(BuildContext context) {
     return SafeArea(
      ...
      floatingActionButton: BlocConsumer<SportsClothesCubit, SportsClothesState>(
                listener: (context, state) {
      
                },
                builder: (context, state) {
      var cubit = SportsClothesCubit.get(context);
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<SportsClothesCubit, SportsClothesState>(
          listener: (context, state) {
            
          },
          builder: (context, state) {
            if(state is SportsClothesSuccess){
            var cubit = SportsClothesCubit.get(context);
          ...
          else if (state is SportsClothesFailure){
  ...
  Future<void> updateDialog(BuildContext context, String? newval, SportsClothesSuccess state, int index, SportsClothesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, SportsClothesCubit cubit, int index) {
