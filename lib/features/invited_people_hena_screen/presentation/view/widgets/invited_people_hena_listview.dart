...
class InvitedPeopleHenaListvieew extends StatelessWidget {
  const InvitedPeopleHenaListvieew({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<InvitedPeopleHenaScreenCubit, InvitedPeopleHenaScreenState>(
      listener: (context, state) {
        
      },
      builder: (context, state) {
        var cubit = InvitedPeopleHenaScreenCubit.get(context);
        if(state is GetInvitedPeopleHenaScreenFailure){
  ...
  void deleteDialog(BuildContext context, InvitedPeopleHenaScreenCubit cubit, int index) {
