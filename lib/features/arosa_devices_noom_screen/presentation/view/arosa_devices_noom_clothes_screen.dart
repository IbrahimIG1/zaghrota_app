...
class ArosaDevicesNoomClothesScreen extends StatelessWidget {
  const ArosaDevicesNoomClothesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      floatingActionButton: BlocConsumer<NoomClothesCubit, NoomClothesState>(
                listener: (context, state) {
      
                },
                builder: (context, state) {
      var cubit = NoomClothesCubit.get(context);
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<NoomClothesCubit, NoomClothesState>(
          listener: (context, state) {
            
          },
          builder: (context, state) {
            if(state is NoomClothesSuccess){
            var cubit = NoomClothesCubit.get(context);
          ...
          else if (state is NoomClothesFailure){
  ...
  Future<void> updateDialog(BuildContext context, String? newval, NoomClothesSuccess state, int index, NoomClothesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, NoomClothesCubit cubit, int index) {
