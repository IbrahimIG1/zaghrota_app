...
class SessionScreenGridviewItem extends StatelessWidget {
  const SessionScreenGridviewItem({super.key, required this.img, required this.title, this.value, this.onChanged});
final String img;
final String title;
final bool? value;
