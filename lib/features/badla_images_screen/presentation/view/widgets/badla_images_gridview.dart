...
class BadlaImagesGridview extends StatelessWidget {
  const BadlaImagesGridview({super.key, required this.type});
  final String type;
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          BlocConsumer<BadlaImagesCubit, BadlaImagesState>(
            listener: (context, state) {
             
            },
            builder: (context, state) {
              if(state is BadlaImagesSuccess){
              return GridView.builder(
              ...
              else if(state is BadlaImagesFailure){
                return Column(children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                    BlocProvider.of<BadlaImagesCubit>(context).getImages(type: type);
