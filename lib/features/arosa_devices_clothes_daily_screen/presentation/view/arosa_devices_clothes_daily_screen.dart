...
class ArosaDevicesClothesDailyScreen extends StatelessWidget {
  const ArosaDevicesClothesDailyScreen({super.key});
  ...
  Widget build(BuildContext context) {
     return SafeArea(
      ...
      floatingActionButton: BlocConsumer<DevicesDailyClothesCubit, DevicesDailyClothesState>(
                listener: (context, state) {
      
                },
                builder: (context, state) {
      var cubit = DevicesDailyClothesCubit.get(context);
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<DevicesDailyClothesCubit, DevicesDailyClothesState>(
          listener: (context, state) {
            
          },
          builder: (context, state) {
            if(state is DevicesDailyClothesSuccess){
            var cubit = DevicesDailyClothesCubit.get(context);
          ...
          else if (state is DevicesDailyClothesFailure){
  ...
  Future<void> updateDialog(BuildContext context, String? newval, DevicesDailyClothesSuccess state, int index, DevicesDailyClothesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, DevicesDailyClothesCubit cubit, int index) {
