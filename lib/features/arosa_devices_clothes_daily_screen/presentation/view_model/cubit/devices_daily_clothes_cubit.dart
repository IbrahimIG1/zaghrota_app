...
import 'package:zaghrota_app/features/arosa_devices_clothes_daily_screen/data/arosa_devices_clothes_daily_screen_repo.dart';

part 'devices_daily_clothes_state.dart';

class DevicesDailyClothesCubit extends Cubit<DevicesDailyClothesState> {
  DevicesDailyClothesCubit() : super(DevicesDailyClothesInitial());
  ArosaDevicesClothesDailyScreenRepo repo = ArosaDevicesClothesDailyScreenRepo();
GlobalKey<FormState> formKey = GlobalKey();
 static DevicesDailyClothesCubit get(context)=> BlocProvider.of<DevicesDailyClothesCubit>(context);
