...
class ArosaDevicesCentianScreen extends StatelessWidget {
  const ArosaDevicesCentianScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      floatingActionButton: BlocConsumer<CentainClothesCubit, CentainClothesState>(
                listener: (context, state) {
      
                },
                builder: (context, state) {
      var cubit = CentainClothesCubit.get(context);
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<CentainClothesCubit, CentainClothesState>(
          listener: (context, state) {
            
          },
          builder: (context, state) {
            if(state is CentainClothesSuccess){
            var cubit = CentainClothesCubit.get(context);
          ...
          else if (state is CentainClothesFailure){
  ...
  Future<void> updateDialog(BuildContext context, String? newval, CentainClothesSuccess state, int index, CentainClothesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, CentainClothesCubit cubit, int index) {
