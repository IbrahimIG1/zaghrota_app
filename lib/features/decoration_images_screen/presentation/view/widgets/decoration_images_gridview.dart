...
class DecorationImagesGridview extends StatelessWidget {
  const DecorationImagesGridview({super.key, required this.type});
   final String type;
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          BlocConsumer<DecorationImagesCubit, DecorationImagesState>(
            listener: (context, state) {
             
            },
            builder: (context, state) {
              if(state is DecorationImagesSuccess){
              return GridView.builder(
              ...
              else if(state is DecorationImagesFailure){
                return Column(children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                    BlocProvider.of<DecorationImagesCubit>(context).getImages(type: type);
