...
class ArosaDevicesShoesScreen extends StatelessWidget {
  const ArosaDevicesShoesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      floatingActionButton: BlocConsumer<ShoesClothesCubit, ShoesClothesState>(
                listener: (context, state) {
      
                },
                builder: (context, state) {
      var cubit = ShoesClothesCubit.get(context);
      ...
      body: SingleChildScrollView(
        child: BlocConsumer<ShoesClothesCubit, ShoesClothesState>(
          listener: (context, state) {
            
          },
          builder: (context, state) {
            if(state is ShoesClothesSuccess){
            var cubit = ShoesClothesCubit.get(context);
          ...
          else if (state is ShoesClothesFailure){
  ...
  Future<void> updateDialog(BuildContext context, String? newval, ShoesClothesSuccess state, int index, ShoesClothesCubit cubit) {
   ...
   void deleteDialog(BuildContext context, ShoesClothesCubit cubit, int index) {
