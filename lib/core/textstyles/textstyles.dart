...
class Textstyles {
  ...
  static TextStyle weddingNames = TextStyle(color: Colors.black,fontSize: 15.sp,fontWeight: FontWeights.medium);
  static TextStyle listViewTitles = TextStyle(fontWeight: FontWeights.thin,fontSize: 20.sp);
  static TextStyle heartViewTextStyle = TextStyle(fontSize: 13.sp);
